Pod::Spec.new do |s|
  ...
  s.source = { :git => "https://github.com/jyotikdev/r2distributiontest.git" }

  s.vendored_frameworks = 'XCFrameworks/MobilePaymentsSDK.xcframework.zip/MobilePaymentsSDK.xcframework'
