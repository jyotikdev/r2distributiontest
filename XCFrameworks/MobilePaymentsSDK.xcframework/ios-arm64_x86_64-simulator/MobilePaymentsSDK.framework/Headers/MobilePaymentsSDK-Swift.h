...
#ifndef MOBILEPAYMENTSSDK_SWIFT_H
#define MOBILEPAYMENTSSDK_SWIFT_H
...
#endif
// Generated by Apple Swift version 5.9.2 (swiftlang-5.9.2.2.56 clang-1500.1.0.2.5)
#ifndef READERSDK2API_SWIFT_H
#define READERSDK2API_SWIFT_H
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wgcc-compat"
...
#if defined(__OBJC__)
enum SQMPAlternatePaymentMethodType : NSUInteger;
@class NSString;
@protocol SQMPPaymentSource;

/// The alternate payment method that we are attempting to charge.
SWIFT_PROTOCOL_NAMED("AlternatePaymentMethod")
@protocol SQMPAlternatePaymentMethod <NSObject>
/// The type of the payment that is being presented
@property (nonatomic, readonly) enum SQMPAlternatePaymentMethodType type;
...
typedef SWIFT_ENUM_NAMED(NSUInteger, SQMPAlternatePaymentMethodType, "AlternatePaymentMethodType", open) {
/// Instructs the SDK to begin a payment for a keyed in credit card.
  SQMPAlternatePaymentMethodTypeKeyed = 0,
/// Instructs the SDK to charge a Card on File
  SQMPAlternatePaymentMethodTypeCardOnFile = 1,
/// Instructs the SDK to charge a House Account
  SQMPAlternatePaymentMethodTypeHouseAccount = 2,
/// Instructs the SDK to begin a payment using Apple Tap to Pay
  SQMPAlternatePaymentMethodTypeTapToPay = 3,
};
...
/// Mobile Payments SDK could not connect to the network.
  SQMPAuthorizationErrorNoNetwork = 0,
/// Device is already authorized with a Square account.
  SQMPAuthorizationErrorAlreadyAuthorized = 1,
/// An unexpected error occurred. See the debug code and message for more information.
  SQMPAuthorizationErrorAlreadyInProgress = 2,
/// An unexpected error occurred. See the debug code and message for more information.
  SQMPAuthorizationErrorDeauthorizationInProgress = 3,
/// Authorization code has already been redeemed.
  SQMPAuthorizationErrorAuthorizationCodeAlreadyRedeemed = 4,
/// Authorization code has expired.
  SQMPAuthorizationErrorExpiredAuthorizationCode = 5,
/// Authorization code is invalid.
  SQMPAuthorizationErrorInvalidAuthorizationCode = 6,
/// Access token is invalid.
  SQMPAuthorizationErrorInvalidAccessToken = 7,
/// Access code is empty.
  SQMPAuthorizationErrorEmptyAccessToken = 8,
/// LocationID is invalid.
  SQMPAuthorizationErrorInvalidLocationID = 9,
/// Location is not authorized for card processing
  SQMPAuthorizationErrorLocationNotActivatedForCardProcessing = 10,
/// LocationID is empty.
  SQMPAuthorizationErrorEmptyLocationID = 11,
/// Country is not supported
  SQMPAuthorizationErrorUnsupportedCountry = 12,
/// There is a discrepancy between the device time and the server time.
  SQMPAuthorizationErrorDeviceTimeDoesNotMatchServerTime = 13,
/// Unexpected authorization error.
  SQMPAuthorizationErrorUnexpected = 14,
};
static NSString * _Nonnull const SQMPAuthorizationErrorDomain = @"ReaderSDK2API.AuthorizationError";
...
@property (nonatomic, readonly, strong) id <SQMPLocation> _Nullable authorizedLocation;
...
///
- (void)authorize:(NSString * _Nonnull)accessToken locationID:(NSString * _Nonnull)locationID completion:(void (^ _Nonnull)(NSError * _Nullable))completion;
...
@interface NSBundle (SWIFT_EXTENSION(ReaderSDK2API))
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) NSBundle * _Nonnull readerSDK2APIResourcesBundle;)
+ (NSBundle * _Nonnull)readerSDK2APIResourcesBundle SWIFT_WARN_UNUSED_RESULT;
@end
...
/// returns true if self contains the inputMethods passed in the parameter
...
typedef SWIFT_ENUM_NAMED(NSUInteger, SQMPCurrency, "Currency", open) {
  ...
  SQMPCurrencyJPY = 1,
  SQMPCurrencyUSD = 2,
  SQMPCurrencyUnknown = 3,
};


/// Creates a new payment charged to a House Account
...
@interface SQMPMoney (SWIFT_EXTENSION(ReaderSDK2API))
@property (nonatomic, readonly) NSUInteger hash;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end
...
/// OfflinePaymentQueue is not supported in sandbox environment.
  SQMPOfflinePaymentQueueErrorUnsupportedSandboxEnvironment = 1,
/// Unexpected Error Returned
  SQMPOfflinePaymentQueueErrorUnexpected = 2,
};
static NSString * _Nonnull const SQMPOfflinePaymentQueueErrorDomain = @"ReaderSDK2API.OfflinePaymentQueueError";
...
/// Mobile Payments SDK will automatically stop pairing after a reader is paired.
/// <ul>
///   <li>
///     Return value is <code>true</code> if a pairing was canceled.
///   </li>
/// </ul>
- (BOOL)stop;
@end
...
/// The total stored in the database if this payment is taken offline will exceed the total allowed in offline mode.
  SQMPPaymentErrorOfflineStoredAmountExceeded = 10,
/// Offline processing is unsupported in sandbox environment
  SQMPPaymentErrorSandboxUnsupportedForOfflineProcessing = 11,
/// There is a discrepancy between the device time and the server time.
  SQMPPaymentErrorDeviceTimeDoesNotMatchServerTime = 12,
/// Unsupported mode for taking a payment; for example, multitasking mode is not allowed on iPad.
  SQMPPaymentErrorUnsupportedMode = 13,
/// Unexpected Error Returned
  SQMPPaymentErrorUnexpected = 14,
};
static NSString * _Nonnull const SQMPPaymentErrorDomain = @"ReaderSDK2API.PaymentError";
...
/// Alternate Payment Methods available to create a Payment
@property (nonatomic, readonly, copy) NSArray<id <SQMPAlternatePaymentMethod>> * _Nonnull alternatePaymentMethods;
...
- (id <SQMPPaymentHandle> _Nullable)startPayment:(SQMPPaymentParameters * _Nonnull)paymentParameters from:(UIViewController * _Nonnull)viewController delegate:(id <SQMPPaymentManagerDelegate> _Nonnull)delegate;
...
/// The duration of time after the payment’s creation when Square automatically cancels the payment. This automatic cancellation applies only to payments that don’t reach a terminal state (<code>COMPLETED</code>, <code>CANCELED</code>, or <code>FAILED</code>) before the <code>delayDuration</code> time period.
/// This parameter should be specified as a time duration, in RFC 3339 format, with a minimum value of 1 minute.
/// note:
/// This feature is only supported for card payments. This parameter can only be set for a delayed capture payment (<code>autocomplete=false</code>).
/// note:
/// The minimum value for this parameter is 1 minute.
@property (nonatomic, copy) NSString * _Nullable delayDuration;
/// The amount of money to accept for this payment, not including <code>tipMoney</code>
...
/// Not connected to internet, unable to establish connection.
  SQMPReaderConnectionFailureReasonNotConnectedToInternet = 8,
...
/// Call to server failed for a required update
  SQMPReaderFirmwareUpdateErrorServerCallFailure = 0,
...
/// Reader disconnected during firmware update and didn’t reconnect in time
  SQMPReaderFirmwareUpdateErrorConnectionTimeout = 2,
/// Firmware update failed for unknown reason.
  SQMPReaderFirmwareUpdateErrorUnknownError = 3,
};
static NSString * _Nonnull const SQMPReaderFirmwareUpdateErrorDomain = @"ReaderSDK2API.ReaderFirmwareUpdateError";
...
/// The <code>ReaderManagerProtocol</code> handles interactions with Square card readers, including pairing Bluetooth readers, getting the current set of available readers, and observing changes in available readers.
...
/// Mobile Payments SDK is not currently authorized with a Square Seller account.
  SQMPReaderPairingErrorNotAuthorized = 0,
/// Reader Pairing not supported in sandbox environment
  SQMPReaderPairingErrorNotSupported = 1,
/// Pairing did not complete in a reasonable time.
  SQMPReaderPairingErrorTimedOut = 2,
/// There is already an active pairing in progress.
  SQMPReaderPairingErrorReaderAlreadyPairing = 3,
/// Reader was unable to pair.
  SQMPReaderPairingErrorFailedToConnect = 4,
/// The bluetooth connection on the device is disabled.
  SQMPReaderPairingErrorBluetoothDisabled = 5,
/// The SDK is requiring an update to occur.
  SQMPReaderPairingErrorUpdateRequired = 6,
/// Bluetooth permission has not been determined.
  SQMPReaderPairingErrorBluetoothPermissionNotDetermined = 7,
/// Bluetooth permission is restricted.
  SQMPReaderPairingErrorBluetoothPermissionRestricted = 8,
/// Bluetooth permission has been denied.
  SQMPReaderPairingErrorBluetoothPermissionDenied = 9,
/// Bluetooth permission is unknown.
  SQMPReaderPairingErrorBluetoothPermissionUnknownCase = 10,
/// Bluetooth is not supported.
  SQMPReaderPairingErrorBluetoothNotSupported = 11,
/// Bluetooth is not ready.
  SQMPReaderPairingErrorBluetoothNotReady = 12,
/// Bluetooth is resetting.
  SQMPReaderPairingErrorBluetoothResetting = 13,
...
/// reader.
  SQMPReaderPairingErrorBondingRemoved = 14,
/// Bluetooth has encountered an  unknown error.
  SQMPReaderPairingErrorBluetoothUnknownError = 15,
};
static NSString * _Nonnull const SQMPReaderPairingErrorDomain = @"ReaderSDK2API.ReaderPairingError";
...
/// Instructs the SDK to begin an Apple Tap to Pay Payment
...
/// Mobile Payments SDK could not connect to the network.
  SQMPTapToPayReaderErrorNoNetwork = 0,
/// Mobile Payments SDK is not currently authorized with a Square Seller account.
  SQMPTapToPayReaderErrorNotAuthorized = 1,
/// Tap To Pay Reader is not available
  SQMPTapToPayReaderErrorNotAvailable = 2,
/// Account is already linked for Tap to Pay. No need to link again
  SQMPTapToPayReaderErrorAlreadyLinked = 3,
/// User canceled linking/relinking operation
  SQMPTapToPayReaderErrorLinkingCanceled = 4,
/// Specific Apple ID is unable to be linked for Tap to Pay
  SQMPTapToPayReaderErrorLinkingFailed = 5,
/// The device is not supported for Tap to Pay Operation
  SQMPTapToPayReaderErrorUnsupportedDeviceModel = 6,
/// The device’s OS is not supported for Tap to Pay Operation
  SQMPTapToPayReaderErrorUnsupportedOSVersion = 7,
/// The device does not have a passcode set
  SQMPTapToPayReaderErrorPasscodeDisabled = 8,
/// Device is banned or merchant is blocked by Apple from using Tap to Pay
  SQMPTapToPayReaderErrorBanned = 9,
/// SDK could not generate a valid JWT token for PaymentCardReader API
  SQMPTapToPayReaderErrorInvalidToken = 10,
/// Network response returned an error
  SQMPTapToPayReaderErrorNetworkError = 11,
/// Tap To Pay Reader received an error
  SQMPTapToPayReaderErrorOther = 12,
/// An unexpected error has occured
  SQMPTapToPayReaderErrorUnexpected = 13,
};
static NSString * _Nonnull const SQMPTapToPayReaderErrorDomain = @"ReaderSDK2API.TapToPayReaderError";
